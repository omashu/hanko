...
contextBridge.exposeInMainWorld('hanko', {
  ...
  saveCroppedAvatar: (dataUrl) => ipcRenderer.invoke('profile:saveCroppedAvatar', dataUrl),
  ...
  anilibriaPopularReal: () => ipcRenderer.invoke('anilibria:popularReal'),
  jikanTopManga: () => ipcRenderer.invoke('jikan:topManga'),
  anilibriaEpisodes: (animeId) => ipcRenderer.invoke('anilibria:episodes', animeId),
  animeRelatedTimeline: (title) => ipcRenderer.invoke('anime:relatedTimeline', title),
  ...
  animeonSearch: (query) => ipcRenderer.invoke('animeon:search', query),
  animeonDetails: (animeId) => ipcRenderer.invoke('animeon:details', animeId),
  animeonResolve: (link) => ipcRenderer.invoke('animeon:resolve', link),
  animruFindForTitle: (title) => ipcRenderer.invoke('animru:findForTitle', title),
  animruResolve: (vkId) => ipcRenderer.invoke('animru:resolve', vkId),
  ...
  onlineSetActivity: (activity) => ipcRenderer.invoke('online:setActivity', activity),
  ...
  onlineCreateGroup: (payload) => ipcRenderer.invoke('online:createGroup', payload),
  onlineListGroups: () => ipcRenderer.invoke('online:listGroups'),
  onlineListGroupMembers: (groupId) => ipcRenderer.invoke('online:listGroupMembers', groupId),
  onlineAddGroupMember: (payload) => ipcRenderer.invoke('online:addGroupMember', payload),
  onlineLeaveGroup: (groupId) => ipcRenderer.invoke('online:leaveGroup', groupId),
  onlineRemoveGroupMember: (payload) => ipcRenderer.invoke('online:removeGroupMember', payload),
  onlineSetGroupName: (payload) => ipcRenderer.invoke('online:setGroupName', payload),
  onlineSetGroupAvatar: (payload) => ipcRenderer.invoke('online:setGroupAvatar', payload),
  onlineSendGroupMessage: (payload) => ipcRenderer.invoke('online:sendGroupMessage', payload),
  onlineListGroupMessages: (groupId) => ipcRenderer.invoke('online:listGroupMessages', groupId),
  onlineMarkGroupRead: (groupId) => ipcRenderer.invoke('online:markGroupRead', groupId),
  groupSaveCroppedAvatar: (payload) => ipcRenderer.invoke('group:saveCroppedAvatar', payload),
  ...
  onLibraryUpdatesFound: (cb) => {
    ipcRenderer.on('library:updatesFound', (_e, data) => cb(data));
  },
